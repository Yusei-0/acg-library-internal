...
export default declareComponent(ProjectCard, {
  ...
  props: {
    ...
    width: props.Text({
      ...
      defaultValue: '100%',
      group: 'Size',
      tooltip: 'Accepts CSS values like 100%, 520px, min(100%, 640px), or var(...).',
    }),
    tabletWidth: props.Text({
      name: 'Tablet Width',
      defaultValue: '',
      group: 'Size',
      tooltip: 'Optional. Falls back to desktop when empty.',
    }),
    mobileWidth: props.Text({
      name: 'Mobile Width',
      defaultValue: '',
      group: 'Size',
    ...
    minWidth: props.Text({
      ...
      defaultValue: '0',
      group: 'Size',
      tooltip: 'Accepts any CSS width value. Use 0 when no minimum is needed.',
    }),
    tabletMinWidth: props.Text({
      name: 'Tablet Min Width',
      defaultValue: '',
      group: 'Size',
      tooltip: 'Optional. Falls back to desktop when empty.',
    }),
    mobileMinWidth: props.Text({
      name: 'Mobile Min Width',
      defaultValue: '',
      group: 'Size',
      tooltip: 'Optional. Falls back to tablet, then desktop, when empty.',
    }),
    maxWidth: props.Text({
      ...
      defaultValue: 'none',
      group: 'Size',
      tooltip: 'Accepts any CSS width value. Use none when no maximum is needed.',
    }),
    tabletMaxWidth: props.Text({
      name: 'Tablet Max Width',
      defaultValue: '',
      group: 'Size',
      tooltip: 'Optional. Falls back to desktop when empty.',
    }),
    mobileMaxWidth: props.Text({
